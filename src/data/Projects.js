...
const projects = [
  {
    ...
    description:
      'Assessment completed in 24 hours. Fetch student data from API, compute and display in stylized list of cards, where Tags can added to any. Filter list by name and tag.',
    cardImagePath: '',
    imageFileName: '',
    imageFilePath: '',
    interactPage: true,
    portfolioPage: false,
    url: 'https://compassionate-banach-6a47ed.netlify.app/',
    url_gitHub: '',
    techs: ['React'],
    techIcons: [require('../assets/images/tech/icon-react.png')],
  },
  {
    key: 13,
    id: 13,
